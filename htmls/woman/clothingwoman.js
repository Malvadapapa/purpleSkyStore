...
const appState = {
  products: DIVIDE_PRODUCTS_PAGINATION(6, productsData.woman),
  currentProductsIndex: 0,
  productsLength: DIVIDE_PRODUCTS_PAGINATION(6, productsData.woman).length,
  isThereAnyFilter: false,
  filteredProducts: DIVIDE_PRODUCTS_PAGINATION(6, productsData.woman),
  currentFilteredProductsIndex: 0,
  filteredProductsLength: DIVIDE_PRODUCTS_PAGINATION(6, productsData.woman)
    .length,
};
